...
Abre ARCANVEIL normalmente. Al escribir al menos 8 caracteres en la descripción, la vista procedural aparece de inmediato y la pintura local la sustituye al terminar. La primera generación tarda más; las siguientes con los mismos criterios salen de `.rollapp-images`.
